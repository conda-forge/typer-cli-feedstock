...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/typer-cli-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10105&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/typer-cli-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `typer-cli` can be installed with:

```
conda install typer-cli
```

It is possible to list all of the versions of `typer-cli` available on your platform with:
